...
describe('Constants Validation', () => {
  describe('FILM_CHARACTERISTICS', () => {
    ...
    it('should have different characteristics for each film type', () => {
      ...
      const ilfordValues = [
        ilford.contrast,
        ilford.grainClumping,
        ilford.colorVariation,
      ];
  ...
  describe('EXPOSURE_CONVERSION', () => {
    ...
    it('should have valid luminance weights that sum to 1', () => {
      ...
      const sum =
        LUMINANCE_WEIGHTS.red +
        LUMINANCE_WEIGHTS.green +
        LUMINANCE_WEIGHTS.blue;
    ...
    it('should have valid ISO parameters', () => {
      ...
      expect(EXPOSURE_CONVERSION.ISO_LOG_FACTOR).toBeCloseTo(
        expectedLogFactor,
        5
      );
    });
