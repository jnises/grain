...
describe('Wang Hash Statistical Properties', () => {
  describe('seededRandom', () => {
    ...
    it('should handle edge cases properly', () => {
      ...
      // Test with decimals (should be handled by conversion to integer)
      expect(() => seededRandom(123.456)).not.toThrow();
    });

    it('should handle integer inputs correctly', () => {
      // Test wangHash32 directly with integer inputs
      expect(() => wangHash32(42)).not.toThrow();
      expect(() => wangHash32(0)).not.toThrow();
      expect(() => wangHash32(-5)).not.toThrow();

      // Test that different integers produce different hashes
      const hash1 = wangHash32(42);
      const hash2 = wangHash32(43);
      const hash3 = wangHash32(0);
      ...
      expect(wangHash32(42)).toBe(hash1);
    });
